...
resource "azurerm_lb" "lb" {
  ...
  dynamic "frontend_ip_configuration" {
    ...
    content {
      ...
      subnet_id                     = try(var.vnets[frontend_ip_configuration.value.vnet_key].subnets[frontend_ip_configuration.value.subnet_key].id, frontend_ip_configuration.value.subnet_id, null)
      ...
      public_ip_address_id          = lookup(frontend_ip_configuration.value, "public_ip_address_key", null) == null ? null : var.public_ip_addresses[frontend_ip_configuration.value.public_ip_address_key].id
